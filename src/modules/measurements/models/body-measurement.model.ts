...
export class BodyMeasurement extends Model {
  ...
  @Column({ type: DataType.DECIMAL(5, 1), allowNull: true }) abs!: number;
  @Column({ type: DataType.DECIMAL(5, 1), allowNull: true }) glutes!: number;
  @Column({ type: DataType.DECIMAL(5, 1), allowNull: true }) thigh!: number;
  @Column({ type: DataType.DECIMAL(5, 1), allowNull: true }) calf!: number;
